...
**This fork has updated build dependencies.**

## Dependencies
* google-play-services_lib library from the Android SDK (at least version 4.4.+))
* android-support-v7-mediarouter (version 19.+ or above)
